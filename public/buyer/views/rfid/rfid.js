...
angular.module('inspinia',[
  ...
  .controller('RfidCtrl', function($rootScope,$scope,$http,$location,$filter,MyCache,$window) {
	  ...
	  //console.log('member');
}).factory('Rfid',function($resource){
	return $resource('/buyer/Rfid/:tagid', { tagid: '@tagid'}, {
		update:{ method:'PUT'},
		get:{ cache:false},
        save: {
            method: 'POST',
	...
	return $resource('/buyer/Buyer/:buyerSq', { buyerSq: '@buyerSq'}, {
		update:{ method:'PUT'},
		get:{ cache:false},
        save: {
            method: 'POST',
