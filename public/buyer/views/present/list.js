...
angular.module('inspinia',
  ...
  .controller('ListCtrl', function($rootScope,$scope,$http,$location,$filter,$q,Gift,$stateParams,$state,$modal) {
	...
	$scope.pageChanged = function(p) {
		$scope.sform.page=p;
		$state.go('present.list',$scope.sform); 
    };	
	// 초기 데이타로드 
	$scope.doSearch=function(){
		
		$q.all([Gift.query($scope.sform).$promise]).then(function(results){
