...
.controller('StatLaundryDailyCtrl', function($rootScope,$scope,$http,$location,$filter,$q,$stateParams,$state) {
    ...
    $scope.sform.page=p;
    $state.go('stat.laundrydailylist',$scope.sform); 
    };	
    // 초기 데이타로드 
    $scope.doSearch=function(){
        $http.get('/buyer/StatLaundryDailyList',{params:$scope.sform}).then(function(rs){
            $scope.list = rs.data;
        },function(err){
