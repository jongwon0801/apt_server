...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
	$urlRouterProvider.when('home', '/member/list');
    ...
    $ocLazyLoadProvider.config({
        ...
        modules: [
            ...
            {name: 'LaundryNoticeEditModule',	files:['views/laundry/notice.edit.js']},
            {name: 'LaundryNoticeViewModule',	files:['views/laundry/notice.view.js']},
        	{name: 'LaundryNoticeListModule',	files:['views/laundry/notice.list.js']},
            ...
            {name: 'AppleboxLogListModule',files:['views/applebox/appleboxloglist.js']},
            ...
            {name: 'AppleboxLockerListModule',files:['views/applebox/lockerlist.js']},
            ...
            {name: 'AppleboxHouseModule',files:['views/applebox/house.js']},
            ...
            {name: 'ConfigServerModule', files:['views/config/server.js']},
            {name: 'ConfigSmsListModule', files:['views/config/smslist.js']},
            {name: 'ConfigNoticeListModule', files:['views/config/notice_list.js']},
            {name: 'ConfigNoticeEditModule', files:['views/config/notice_edit.js']},
            {name: 'ConfigVpnListModule', files:['views/config/vpn_list.js']},
            {name: 'OkboxListModule', files:['views/okbox/list.js']},
            {name: 'OkboxEditModule', files:['views/okbox/edit.js']},
            ...
            {name: 'OrderThingsNewModule',files:['views/order/things.new.js']},
            {name: 'OrderSuperListModule',files:['views/order/super.list.js']},
            {name: 'OrderPayListModule',files:['views/order/pay.list.js']}
    ...
    $stateProvider
        ...
        .state('member.list', {
            url: "/list?page&startDate&endDate&hp&memberType&status&media",
        ...
        .state('order.paylist', {
            url: "/paylist?page&startDate&endDate&status&kind&hp&name&shopSq",
            templateUrl: 'views/order/pay.list.html',
            authenticate: true,
        })
        ...
        .state('order.thingsnew', {
            url: "/thingnew",
            templateUrl: 'views/order/things.new.html',
            authenticate: true,
        })
        ...
        .state('laundry', {
            ...
            resolve: {
            	loadMyCtrl: ['$ocLazyLoad', function($ocLazyLoad) {
            		return $ocLazyLoad.load(['views/laundry/laundry.js']);
            	}]
            }
            
        })
        .state('laundry.noticelist', {
            url: "/noticelist?page&startDate&endDate&userId&memberType&status",
            templateUrl: 'views/laundry/notice.list.html',
            authenticate: true,
        })
        .state('laundry.noticeedit', {
            url: "/noticeedit/:laundryNoticeSq",
            templateUrl: "views/laundry/notice.edit.html",
            authenticate: true
        })
        .state('shop', {
            abstract: true,
        ...
        .state('okbox', {
            abstract: true,
            url: "/okbox",
            controller:'OkboxCtrl',
            resolve: {
            	loadMyCtrl: ['$ocLazyLoad', function($ocLazyLoad) {
            		return $ocLazyLoad.load(['views/okbox/okbox.js']);
            	}]
            },
            templateUrl: "views/common/content.html"
        ...
        .state('okbox.edit', {
            url: "/edit/:donationSq",
            templateUrl: "views/okbox/edit.html",
            authenticate: true
        })
        .state('okbox.list', {
            url: "/list?page&startDate&endDate&display&dest_phone&status",
            templateUrl: 'views/okbox/list.html',
            authenticate: true,
        })
        .state('config', {
            abstract: true,
            ...
            resolve: {
            	loadMyCtrl: ['$ocLazyLoad', function($ocLazyLoad) {
            		return $ocLazyLoad.load(['views/config/config.js']);
            	}]
            },
            templateUrl: "views/common/content.html"
        ...
        .state('config.server', {
            url: "/server",
            templateUrl: 'views/config/server.html',
            authenticate: true,
        })
        .state('config.sms', {
            url: "/sms",
        ...
        .state('config.smslist', {
            url: "/smslist?page&startDate&request_time&display&dest_phone&status&rsYn",
            templateUrl: 'views/config/smslist.html',
            authenticate: true,
        })
        .state('config.noticelist', {
            url: "/noticelist?page&startDate&request_time&display&dest_phone&status&rsYn",
            templateUrl: 'views/config/notice_list.html',
            authenticate: true,
        })
        .state('config.noticeedit', {
            url: "/noticedit/:noticeSq",
            templateUrl: 'views/config/notice_edit.html',
            authenticate: true,
        })
        .state('config.vpnlist', {
            url: "/vpnlist?page&startDate&request_time&display&dest_phone&status&name",
            templateUrl: 'views/config/vpn_list.html',
            authenticate: true,
        })
       .state('rfid', {
            abstract: true,
        ...
        .state('applebox.list', {
        	url: "/list?page&startDate&endDate&name&status&buyerSq",
            templateUrl: "views/applebox/list.html",
            
        })
        .state('applebox.appleboxloglist', {
        	url: "/appleboxloglist?page&startDate&endDate&companyName&status&yid",
            templateUrl: "views/applebox/appleboxloglist.html",
        ...
        .state('applebox.lockerlist', {
        	url: "/lockerlist?page&toName&toHp&saveName&saveHp&saveDate&yid&status&dwhere&pwd",
            templateUrl: "views/applebox/lockerlist.html",
            
        })
        .state('applebox.saveloglist', {
        	url: "/saveloglist?page&startDate&endDate&companyName&status&buyerSq&yid&uuid&saveHp&saveName&toHp&usage&saveDate&toDong&toHo",
            templateUrl: "views/applebox/saveloglist.html",
            
        })
        .state('applebox.takeloglist', {
        	url: "/takeloglist?page&startDate&endDate&regDate&status&toName&yid&uuid&saveHp&toHp&usage",
            templateUrl: "views/applebox/takeloglist.html",
            
        })
        .state('applebox.house', {
            url: "/house/:yid/?page&startDate&endDate&regDate&status&toName&uuid&saveHp&toHp&usage",
            templateUrl: "views/applebox/house.html",
        ...
        .state('applebox.status', {
            url: "/status?page&startDate&endDate&companyName&status&buyerSq&yid&uuid&saveHp&toHp&usage",
