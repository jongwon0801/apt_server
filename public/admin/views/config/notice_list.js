...
angular.module('inspinia',
  ...
  .controller('NoticeListCtrl', function($rootScope,$scope,$http,$location,$filter,$q,Notice,$stateParams,$state,MyCache) {
	...
	$scope.pageChanged = function(p) {
		$scope.sform.page=p;
		$state.go('config.noticelist',$scope.sform); 
    };
	...
	$scope.doSearch=function(){
		...
		$q.all([Notice.query($scope.sform).$promise,$scope.myCache.loadGCode(['notice.status','notice.kind'])]).then(function(results){
