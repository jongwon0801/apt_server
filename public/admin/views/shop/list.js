...
angular.module('inspinia',
  ...
  .controller('ShopListCtrl', function($rootScope,$scope,$http,$location,$filter,$q,Shop,$stateParams,$state) {
	...
	$scope.doSearch=function(){
		...
		$q.all([Shop.query($scope.sform).$promise,$scope.myCache.loadGCode(['shop.status','shop.kind'])]).then(function(results){
