...
angular.module('inspinia',
  ...
  .controller('OkboxListCtrl', function($rootScope,$scope,$http,$location,$filter,$q,Donation,$stateParams,$state,MyCache) {
	...
	$scope.pageChanged = function(p) {
		$scope.sform.page=p;
		$state.go('okbox.list',$scope.sform); 
    };
	...
	$scope.doSearch=function(){
		...
		$q.all([Donation.query($scope.sform).$promise,$scope.myCache.loadGCode(['donation.status'])]).then(function(results){
