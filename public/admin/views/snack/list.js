...
angular.module('inspinia',
  ...
  .controller('SnackListCtrl', function($rootScope,$scope,$http,$location,$filter,$q,AutoOrder,$stateParams,$state,MyCache) {
	...
	$scope.pageChanged = function(p) {
		$scope.sform.page=p;
		$state.go('snack.list',$scope.sform); 
    };
	...
	$scope.doSearch=function(){
		...
		$q.all([AutoOrder.query($scope.sform).$promise,MyCache.loadGCode([])]).then(function(results){
