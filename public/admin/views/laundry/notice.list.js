...
angular.module('inspinia',
  ...
  .controller('LaundryNoticeListCtrl', function($rootScope,$scope,$http,$location,$filter,$q,LaundryNotice,$stateParams,$state,MyCache) {
	...
	$scope.pageChanged = function(p) {
		$scope.sform.page=p;
		$state.go('laundry.noticelist',$scope.sform); 
    };
	...
	$scope.doSearch=function(){
		...
		$q.all([LaundryNotice.query($scope.sform).$promise,$scope.myCache.loadGCode(['notice.status','notice.kind'])]).then(function(results){
